...
import com.fivehundredpx.api.BuildConfig;
import com.fivehundredpx.api.FiveHundredException;
import com.fivehundredpx.api.R;
...
public class FiveHundredPxOAuthActivity extends Activity {
    ...
    public static final String CONSUMER_KEY = "com.fivehundredpx.api.auth.fivehundredpxoauthactivity.CONSUMER_KEY";
    public static final String CONSUMER_SECRET = "com.fivehundredpx.api.auth.fivehundredpxoauthactivity.CONSUMER_SECRET";
    public static final String ACCESS_TOKEN = "com.fivehundredpx.api.auth.fivehundredpxoauthactivity.ACCESS_TOKEN";
    public static final String EXCEPTION = "com.fivehundredpx.api.auth.fivehundredpxoauthactivity.EXCEPTION";
    ...
    protected void onNewIntent(Intent intent) {
        ...
        if (response.getScheme().equals(FiveHundredPxOAuthHelper.FIVE_HUNDRED_PX_CALLBACK_URL_SCHEME)
                && response.getHost().equals(BuildConfig.FIVE_HUNDRED_PX_OAUTH_CALLBACK_URL)) {
