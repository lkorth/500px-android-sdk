...
public class FiveHundredPxOAuthHelper {
    ...
    public static final String FIVE_HUNDRED_PX_CALLBACK_URL_SCHEME = "fivehundredpx";
    ...
    public String getAuthorizationUrl() throws OAuthCommunicationException, OAuthExpectationFailedException,
        ...
        return mOAuthProvider.retrieveRequestToken(mOAuthConsumer, FIVE_HUNDRED_PX_CALLBACK_URL_SCHEME +
                "://" + BuildConfig.FIVE_HUNDRED_PX_OAUTH_CALLBACK_URL + "/");
    }

    public void parseAuthorizationResponse(Uri redirectedUri) {
        mVerifier = redirectedUri.getQueryParameter(OAuthConstants.VERIFIER);
    }
